...
- [ClientTransportOptions](interfaces/ClientTransportOptions.md)
- [Getter](interfaces/Getter.md)
...
- [CreateState](type-aliases/CreateState.md)
...
- [StoreReturn](type-aliases/StoreReturn.md)
